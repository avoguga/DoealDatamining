...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './concessao.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONCESSAO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONCESSAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONCESSAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONCESSAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONCESSAO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONCESSAO actions', async () => {
      const expectedActions = [
        {
