...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './diario.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIARIO actions', async () => {
      const expectedActions = [
        {
