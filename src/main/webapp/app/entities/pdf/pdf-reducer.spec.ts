...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pdf.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PDF_LIST actions', async () => {
    ...
    it('dispatches FETCH_PDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PDF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PDF actions', async () => {
      const expectedActions = [
        {
