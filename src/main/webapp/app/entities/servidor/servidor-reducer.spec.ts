...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './servidor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVIDOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVIDOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVIDOR actions', async () => {
      const expectedActions = [
        {
